...
Decontextify.instance = (instance, klass, deepTraps, flags, toStringTag, inspectCustom) => {
	...
	base.get = (target, key, receiver) => {
		...
		if (key === host.inspectCustom && inspectCustom) return inspectCustom(toStringTag);
	...
	try {
		...
		switch (typeof value) {
			case 'object':
				if (value === null) {
					return null;
				} else if (instanceOf(value, Number))         { return Decontextify.instance(value, host.Number, deepTraps, flags, 'Number', PrimitiveInspector);
				} else if (instanceOf(value, String))         { return Decontextify.instance(value, host.String, deepTraps, flags, 'String', PrimitiveInspector);
				} else if (instanceOf(value, Boolean))        { return Decontextify.instance(value, host.Boolean, deepTraps, flags, 'Boolean', PrimitiveInspector);
				} else if (instanceOf(value, Date))           { return Decontextify.instance(value, host.Date, deepTraps, flags, 'Date', DateInspector);
				...
				} else if (instanceOf(value, RegExp))         { return Decontextify.instance(value, host.RegExp, deepTraps, flags, 'RegExp', DefaultInspector);
...
Contextify.instance = (instance, klass, deepTraps, flags, toStringTag, inspectCustom) => {
	...
	try {
		...
		switch (typeof value) {
			case 'object':
				if (value === null) {
					return null;
				} else if (instanceOf(value, host.Number))         { return Contextify.instance(value, Number, deepTraps, flags, 'Number', PrimitiveInspector);
				} else if (instanceOf(value, host.String))         { return Contextify.instance(value, String, deepTraps, flags, 'String', PrimitiveInspector);
				} else if (instanceOf(value, host.Boolean))        { return Contextify.instance(value, Boolean, deepTraps, flags, 'Boolean', PrimitiveInspector);
				} else if (instanceOf(value, host.Date))           { return Contextify.instance(value, Date, deepTraps, flags, 'Date', DateInspector);
				...
				} else if (instanceOf(value, host.RegExp))         { return Contextify.instance(value, RegExp, deepTraps, flags, 'RegExp', DefaultInspector);
...
const DefaultInspector = (toStringTag) => function inspect(depth, options) {
	// eslint-disable-next-line no-invalid-this
	return this.toString();
};

const DateInspector = (toStringTag) => function inspect(depth, options) {
	// eslint-disable-next-line no-invalid-this
	return Number.isNaN(this.getTime()) ? this.toString() : this.toISOString();
};

const PrimitiveInspector = (toStringTag) => function inspect(depth, options) {
	// eslint-disable-next-line no-invalid-this
	return toStringTag === 'String' ? `[String: '${this.toString()}']` : `[${toStringTag}: ${this.toString()}]`;
};
...
Proxy[host.inspectCustom] = () => '[Function: Proxy]';
